...
anion = {'nitrate': 'nitrate', 'sulphate':'sulphate', 'phosphate':'phosphate', 'chloride':'chloride', 'carbonate':'carbonate', 'cyanide':'cyanide', 'dichromate':'dichromate','ferrocyanide':'ferrocyanide'}
...
def getObjects(line):
    ...
    for i in tagged:
        ...
        try:
            ...
            chemical+= acids[i[0]]
            if temp!="":
                chemicals[temp]= chemical+" acid"
            else:
                chemical_temp = chemical+" acid"
            chemical=""
        except:
            pass
